---
title: '4884 Data Analytics: Student Depression Analysis Project'
output:
  html_document:
    toc: yes
    df_print: paged
...
1) Proportional Bar Chart: We can observe a clear upward trend in depression prevalence (blue bars) as academic pressure increases. Students experiencing higher academic pressure (levels 4 and 5) report higher rates of depression. Interestingly, there is a noticeable dip in depression at academic pressure level 1 compared to level 0. 

2) Boxplot: From a different type of visualization, we can observe that students with depression report significantly higher academic pressure compared to those without.

#### Study Satisfaction and Depression

From the proportional bar chart we can observe that depression rates generally decline as study satisfaction increases.  Students most satisfied with their studies (level 5) show the lowest prevalence of depression and there's a clear spike in depression at satisfaction level 1.
...
- Accuracy (84.3%): Approximately 84% of all predictions were correct, indicating good overall performance and 3rd best result compared to other models.
- Precision (81.85%): Of all the positive predictions made by the model, around 81.85% were correct — suggesting 4th best performance, only better than k-NN.
- Recall (79.4%): The model was able to identify approximately 79.4% of the actual positive cases, maintaining strong sensitivity and 3rd best result, after logistic regression and Naive Bayes.
